...
public class NoventaGrados {
	...
	/**
	 * Método principal que ejecuta la lógica y gestiona el flujo del juego en modo
	 * texto. Captura excepciones para manejar errores y utiliza un bloque finally
	 * para liberar recursos.
	 * 
	 * @param args argumentos opcionales proporcionados desde la línea de comandos
	 ...
	 */
	private static void juego(boolean partidaFinalizada) {
