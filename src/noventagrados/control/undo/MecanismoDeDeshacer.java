...
public interface MecanismoDeDeshacer {
    ...
    /**
     * Consulta el árbitro actual del juego, que refleja el estado del tablero y las jugadas realizadas hasta el momento.
     * 
     ...
     * 
     * Este método elimina la última jugada del historial y restaura el estado del tablero y las piezas a como estaban antes de esa jugada.
     */
    void deshacerJugada();
     ...
     * 
     * Este método aplica una jugada al juego y la almacena en el historial de jugadas, actualizando el estado del tablero.
     * 
