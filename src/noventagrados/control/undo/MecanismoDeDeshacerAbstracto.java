 ...
 * 
 * Esta clase proporciona una implementación parcial para el manejo de un
 * mecanismo de deshacer en un juego. Se encarga de almacenar la fecha de inicio
 * del mecanismo de deshacer y deja algunos métodos como abstractos para que las
 * clases concretas definan su comportamiento específico en relación con el
 * manejo de jugadas y el estado del árbitro.
 * 
